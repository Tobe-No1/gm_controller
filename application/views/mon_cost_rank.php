    ...
    <div id="page-charge-inq" class="page page-current">
        ...
        <div class="content native-scroll">
            <table class="table table-striped">
                ...
                <?php $i=1; foreach ($players as $key => $l): ?>
                    <tr>
                        <td ><?php echo $i++; ?></td>
                        <td ><?php echo $key ?></td>
                        <td ><?php echo $l['name'] ?></td>
                        <!--<td ><?php /*echo $l['name_alias'] */?></td>-->
                        <td ><a href="/index.php/Statistic/play_cost?time=<?php echo $l['t']?>&uid=<?php echo $key?>   "><?php echo $l['cost']; ?></a></td>
